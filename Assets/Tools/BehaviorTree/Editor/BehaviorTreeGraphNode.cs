...
namespace BehaviorTreeEditor
{
    public class BehaviorTreeGraphNode : Node
    {
        ...
        public BehaviorTreeGraphNode(BehaviorTreeNode node,BehaviorTreeGraphView view) : base("Assets/Tools/BehaviorTree/Resources/BehaviorTreeNode.uxml") {
